...
namespace Utils {
  ...
  static inline real_type power4( real_type a ) { return a*a*a*a; }
  static inline real_type power5( real_type a ) { return a*a*a*a*a; }
  static inline real_type power6( real_type a ) { return a*a*a*a*a*a; }
  ...
  init_nonlinear_system_tests() {
    ...
    nonlinear_system_tests.push_back( new ModelEquationsForCombustionOfPropane1() );
    nonlinear_system_tests.push_back( new ModelEquationsForCombustionOfPropane2() );
