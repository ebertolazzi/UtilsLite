...
namespace Utils
{
  ...
  public:
    ...
    {
      Utils::Check( A.rows() == A.cols(), "DenseSymmetricSolver( A, λ={} ) Matrix A must be square.", lambda );
      Utils::Check( Utils::isSymmetric( A ), "DenseSymmetricSolver( A, λ={} ) Matrix A must be symmetric.", lambda );
      m_dim = A.rows();
  ...
  public:
    ...
    {
      Utils::Check( A.rows() == A.cols(), "SparseSymmetricSolver( A, λ={} ) Matrix A must be square.", lambda );
      Utils::Check( Utils::isSymmetric( A ), "SparseSymmetricSolver( A, λ={} ) Matrix A must be symmetric.", lambda );
      m_dim = A.rows();
  ...
  private:
    ...
    struct BlockSolver
    {
      ...
      Vector solve( const Vector & b_block ) const
      {
        ...
        Utils::Check( false, "BlockSolver: solver not initialized" );
        return Vector();
      }
    ...
    void initialize_from_dense( const Matrix & A, Scalar lambda )
    {
      ...
      Utils::Check( A.rows() == A.cols(), "SymmetricSolver( A, λ={} ) Matrix A must be square.", lambda );
      Utils::Check( Utils::isSymmetric( A ), "SymmetricSolver( A, λ={} ) Matrix A must be symmetric.", lambda );
  ...
  public:
    ...
    Vector solve( const Vector & b ) const
    {
      ...
      Utils::Check( false, "SymmetricSolver: invalid strategy" );
      return Vector();
    }
    ...
    void solve_in_place( Vector & b ) const
    {
      ...
      switch ( m_strategy )
      {
        ...
        default: Utils::Check( false, "SymmetricSolver: invalid strategy" );
      }
    }
