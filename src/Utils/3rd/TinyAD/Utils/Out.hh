...
// TinyAD is header-only, hence ordinary NDEBUG does not disable its custom
// assertions.  Allow consuming projects to choose the policy explicitly;
// UtilsLite sets this to 0 for Release builds, while direct TinyAD use retains
// upstream's safe default.
#ifndef TINYAD_ENABLE_RUNTIME_CHECKS
#define TINYAD_ENABLE_RUNTIME_CHECKS 1
#endif
...
#if TINYAD_ENABLE_RUNTIME_CHECKS
...
#define TINYAD_ASSERT(exp) do { } while (false)
#define TINYAD_ASSERT_EQ(a, b) do { } while (false)
#define TINYAD_ASSERT_NEQ(a, b) do { } while (false)
#define TINYAD_ASSERT_G(a, b) do { } while (false)
#define TINYAD_ASSERT_GEQ(a, b) do { } while (false)
#define TINYAD_ASSERT_L(a, b) do { } while (false)
#define TINYAD_ASSERT_LEQ(a, b) do { } while (false)
#define TINYAD_ASSERT_EPS(a, b, eps) do { } while (false)
#define TINYAD_ASSERT_EPS_MAT(A, B, eps) do { } while (false)
#define TINYAD_ASSERT_FINITE(a) do { } while (false)
#define TINYAD_ASSERT_FINITE_MAT(A) do { } while (false)
#define TINYAD_ASSERT_SYMMETRIC(A, eps) do { } while (false)
