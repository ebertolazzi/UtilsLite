...
void print_line_search_statistics()
{
  ...
  {
    Scalar success_rate   = ( stats.total_tests > 0 ) ? 100.0 * static_cast<Scalar>( stats.successful_tests ) /
                                                          static_cast<Scalar>( stats.total_tests )
                                                      : 0.0;
    Scalar avg_iterations = ( stats.successful_tests > 0 ) ? static_cast<Scalar>( stats.total_iterations ) /
